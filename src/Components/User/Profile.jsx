  ...
  return (
    <>
      <div className='flex   h-screen justify-center'>
        <div className='bg-[rgba(51,53,55,255)] gap-9 sm:gap-10 flex sm:items-center flex-col sm:flex-row  px-2 text-[rgba(204,167,25,255)] rounded-xl py-3 w-full md:w-1/2  h-[50%] sm:h-[40%]' >
